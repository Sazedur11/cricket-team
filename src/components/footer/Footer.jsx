...
const Footer = () => {
    return (
        <div className='w-4/5 mx-auto mt-4 pb-10'>
            ...
            <div className='grid md:grid-cols-3 justify-between'>
                <div>
                    ...
                    <p className='text-gray-500'>Lorem ipsum dolor sit amet consectetur, <br /> adipisicing elit. Vitae, qui molestiae?
                    </p>
                </div>
                <div>
                    <h3 className='text-white font-semibold'>Quiks Links</h3>
                    <li className='text-gray-500'><a href="#">Home</a></li>
                    <li className='text-gray-500'><a href="#">About</a></li>
                    <li className='text-gray-500'><a href="#">Services</a></li>
                    <li className='text-gray-500'><a href="#">Contact</a></li>
                </div>
                <div >
                    ...
                    <div className='flex mt-2'>
                        <input className='text-gray-500 bg-white border-1 border-gray-300  py-2 px-4 rounded-s-sm' type="email" placeholder="Enter your email!" id="" />
